...
public class Money implements Comparable<Money> {
	...
	public Money add(Money other) {
		double newAmount = this.universalValue() + other.universalValue();
		return new Money(newAmount/this.getCurrency().getRate(), this.currency);
	}
	...
	public Money sub(Money other) {
		double newAmount = this.amount - other.getAmount();
	...
	public int compareTo(Money other) {
			double diff = this.universalValue() - other.universalValue();
